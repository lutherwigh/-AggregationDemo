...
public abstract class BaseRecyclerViewAapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //head data
    private final List<RecyclerViewModel<T>> headViews;

    //body data
    protected final List<T> mData;

    //foot data
    private final List<RecyclerViewModel<T>> footViews;
    ...
    protected BaseRecyclerViewAapter(List<T> mData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        BaseRecyclerViewHolder holder = new BaseRecyclerViewHolder(binding.getRoot());
     ...
     */
    public void addHeadView(RecyclerViewModel viewLayoutId){
     ...
     */
    public void addFootView(RecyclerViewModel recyclerModel){
    ...
    private void bindData(BaseRecyclerViewHolder holder,int variableId ,T item){
     ...
     * @param item item
     */
    abstract public void bindCustomData(BaseRecyclerViewHolder holder,int position,T item);
